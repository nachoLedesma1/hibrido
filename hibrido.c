...
void proxEstado (Celda **ma, Celda **ma2,Celda **sup1, Celda **sup2, Celda **inf1, Celda **inf2 ,int cantCelReal, int t, int caso, int fila){// el t es el clock
    ...
    #pragma omp parallel num_threads(4)
    {
        ...
        for(int i = 0; i<fila/cantCelReal; i++){//para que haga 10 iteraciones de 30 en el caso de matriz 30x30
            for(int j = 0; j<cantCelReal; j++){//columnas 
                ...
                if((*ma)[(i*(cantCelReal-1))+j].Estado.verde == 1){ // si esta sano
                    if((i == 0 || i == (fila/cantCelReal)) && (j == 0 || j == cantCeldas)){ //Las cuatro esquinas
                        if(j == 0){
                    ...
                    if((i == 0 || i == (fila/cantCelReal)) && (j == 1 || j == cantCeldas -1)){ //fila superior e inferior caso 7
                        if(j == 1){
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+2].Estado.rojo + vecino.rojo;
                    ...
                    if((i == 1 || i == (fila/cantCelReal)-1) && (j == 0 || j == cantCeldas)){//columna izquierda y derecha caso 7
                        if(i == 1){
                            vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[((i+1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[((i+2)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                    ...
                    if((i == 0 || i == (fila/cantCelReal)) && (j > 1 && j < cantCeldas-1)){ //demas casos 1ra fila superior e inferior
                        if(i == 0){
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+2].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-2].Estado.rojo + vecino.rojo;
                    ...
                    if((i > 1 && i < (fila/cantCelReal)-1 ) && (j == 0 || j == cantCeldas)){//demas casos 1 columna izquierda y derecha
                        if(j == 0){
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+2].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[(i*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                            vecino.rojo = (*ma)[((i+2)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                    ...
                    if((i == 1 || i == (fila/cantCelReal)-1) && (j == 1 || j == cantCeldas-1)){ //Segunda casos de las esquinas
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                    ...
                    if((i == 1 || i == (fila/cantCelReal)-1) && (j > 1 && j < cantCeldas-1)){//segundo caso de superior e inferior
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                    ...
                    if((i > 1 && i < (fila/cantCelReal)-1) && (j == 1 || j == cantCeldas-1)){//segundo caso izquierda y derecha
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                    ...
                    if(i >= 3 && i<(fila/cantCelReal)-2 && j>= 3 && j<cantCeldas-2){
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[((i-1)*(cantCelReal-1))+j+1].Estado.rojo + vecino.rojo;
                        vecino.rojo = (*ma)[(i*(cantCelReal-1))+j-1].Estado.rojo + vecino.rojo;
